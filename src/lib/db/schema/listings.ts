...
export const listings = pgTable(
  ...
  (table) => [uniqueIndex("listings_slug_idx").on(table.slug)],
);
...
export const listingOutfits = pgTable("listing_outfits", {
  id: text("id").primaryKey(),
  listingId: text("listing_id")
    .notNull()
    .references(() => listings.id, { onDelete: "cascade" }),
...
export const listingMounts = pgTable("listing_mounts", {
  id: text("id").primaryKey(),
  listingId: text("listing_id")
    .notNull()
    .references(() => listings.id, { onDelete: "cascade" }),
...
export const listingCharms = pgTable("listing_charms", {
  id: text("id").primaryKey(),
  listingId: text("listing_id")
    .notNull()
    .references(() => listings.id, { onDelete: "cascade" }),
...
export const listingBlessings = pgTable("listing_blessings", {
  id: text("id").primaryKey(),
  listingId: text("listing_id")
    .notNull()
    .references(() => listings.id, { onDelete: "cascade" }),
...
export const listingAchievements = pgTable("listing_achievements", {
  id: text("id").primaryKey(),
  listingId: text("listing_id")
    .notNull()
    .references(() => listings.id, { onDelete: "cascade" }),
...
export const listingBosstiaries = pgTable("listing_bosstiaries", {
  id: text("id").primaryKey(),
  listingId: text("listing_id")
    .notNull()
    .references(() => listings.id, { onDelete: "cascade" }),
...
export const listingBestiary = pgTable("listing_bestiary", {
  id: text("id").primaryKey(),
  listingId: text("listing_id")
    .notNull()
    .references(() => listings.id, { onDelete: "cascade" }),
...
export const listingGems = pgTable("listing_gems", {
  id: text("id").primaryKey(),
  listingId: text("listing_id")
    .notNull()
    .references(() => listings.id, { onDelete: "cascade" }),
...
export const listingTitles = pgTable("listing_titles", {
  id: text("id").primaryKey(),
  listingId: text("listing_id")
    .notNull()
    .references(() => listings.id, { onDelete: "cascade" }),
...
export const listingWeaponProficiency = pgTable("listing_weapon_proficiency", {
  id: text("id").primaryKey(),
  listingId: text("listing_id")
    .notNull()
    .references(() => listings.id, { onDelete: "cascade" }),
